...
\item
  Part 3 uses \texttt{SsFrocSampleSize()} which simplifies the procedure to a single function call and applies it to 7 FROC datasets.
\end{itemize}
...
\subsection{Application to all available FROC datasets}\label{application-to-all-available-froc-datasets}}

This is an application of the method to all my available FROC datasets.

\hypertarget{tony-dataset}{%
\subsubsection{TONY dataset}\label{tony-dataset}}
...
\subsubsection{FED dataset, all data and NH treatments only}\label{fed-dataset-all-data-and-nh-treatments-only}}
...
\subsubsection{THOMPSON dataset}\label{thompson-dataset}}
...
\subsubsection{MAGNUS dataset}\label{magnus-dataset}}
...
\subsubsection{LUCY dataset, all data and NH treatments only}\label{lucy-dataset-all-data-and-nh-treatments-only}}
...
\hypertarget{dobbins-1-dataset-all-data-and-nh-treatments-only}{%
\subsubsection{DOBBINS-1 dataset, all data and NH treatments only}\label{dobbins-1-dataset-all-data-and-nh-treatments-only}}
...
\hypertarget{dobbins-3-dataset-all-data-and-nh-treatments-only}{%
\subsubsection{DOBBINS-3 dataset, all data and NH treatments only}\label{dobbins-3-dataset-all-data-and-nh-treatments-only}}
