...
The following code reads the Excel file using the function \texttt{DfReadDataFile()} and saves it to object \texttt{x} and shows the structure of \texttt{x}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x <-}\StringTok{ }\KeywordTok{DfReadDataFile}\NormalTok{(}\StringTok{"R/quick-start/rocCr.xlsx"}\NormalTok{, }\DataTypeTok{newExcelFileFormat =} \OtherTok{TRUE}\NormalTok{)}
\KeywordTok{str}\NormalTok{(x)}
\CommentTok{#> List of 3}
\CommentTok{#>  $ ratings     :List of 3}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str}\NormalTok{(x, }\DataTypeTok{max.level =} \DecValTok{1}\NormalTok{)}
\CommentTok{#> List of 3}
\CommentTok{#>  $ ratings     :List of 3}
\CommentTok{#>  $ lesions     :List of 3}
\CommentTok{#>  $ descriptions:List of 7}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str}\NormalTok{(x}\OperatorTok{$}\NormalTok{ratings)}
\CommentTok{#> List of 3}
\CommentTok{#>  $ NL   : num [1:2, 1:3, 1:8, 1:2] 1.02 2.89 2.21 3.01 2.14 ...}
\CommentTok{#>  $ LL   : num [1:2, 1:3, 1:5, 1:3] 5.28 5.2 5.14 4.77 4.66 4.87 3.01 3.27 3.31 3.19 ...}
\CommentTok{#>  $ LL_IL: logi NA}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str}\NormalTok{(x}\OperatorTok{$}\NormalTok{lesions)}
\CommentTok{#> List of 3}
\CommentTok{#>  $ perCase: int [1:5] 2 1 3 2 1}
\CommentTok{#>  $ IDs    : num [1:5, 1:3] 1 1 1 1 1 ...}
\CommentTok{#>  $ weights: num [1:5, 1:3] 0.3 1 0.333 0.1 1 ...}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions)}
