...
\section{How much finished}\label{quick-start-data-format-how-much-finished}}
...
\section{Excel ROC file format}\label{quick-start-data-format-contents}}
...
\subsection{The false positive (FP/NL) worksheet}\label{quick-start-data-fp-worksheet}}
...
\subsection{The true positive (TP/LL) worksheet}\label{quick-start-data-format-tp-worksheet}}
...
\section{Reading the Excel file}\label{quick-start-read-datafile}}
...
\section{Structure of dataset object}\label{quick-start-read-datafile-structure-roc-dataset}}
