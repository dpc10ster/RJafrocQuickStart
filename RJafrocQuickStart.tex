...
\subsection{DOBBINS-1 dataset, all data and NH treatments only}\label{dobbins-1-dataset-all-data-and-nh-treatments-only}}
...
\subsection{DOBBINS-3 dataset, all data and NH treatments only}\label{dobbins-3-dataset-all-data-and-nh-treatments-only}}
