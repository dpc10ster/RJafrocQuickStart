...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#frocSampleSize(dataset06, J = 5, K = 100, effectSizeROC = 0.05)}
\CommentTok{\#frocSampleSize(dataset01, J = 5, K = 100, effectSizeROC = 0.05)}
\CommentTok{\#frocSampleSize(dataset05, J = 5, K = 100, effectSizeROC = 0.05)}
\CommentTok{\#frocSampleSize(DfExtractDataset(dataset07, trts = c(1,5)), J = 5, K = 100, effectSizeROC = 0.05)}
\CommentTok{\#frocSampleSize(DfExtractDataset(dataset11, trts = c(3,4)), J = 5, K = 100, effectSizeROC = 0.05)}
\end{Highlighting}
\end{Shaded}
