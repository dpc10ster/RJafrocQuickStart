...
\item
  \texttt{Paradigm}: this column contains two cells, \texttt{ROC} and \texttt{factorial}. It informs the software that this is an ROC dataset, and the design is factorial (or fully-crossed), meaning each reader has interpreted each case in each modality.
\end{itemize}
