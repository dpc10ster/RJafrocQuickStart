...
\caption{The Truth worksheet for LROC Excel file `R/quick-start/lroc1.xlsx`}\label{fig:quick-start-lroc-truth}
\end{figure}

\begin{itemize}
\tightlist
\item
  The \texttt{Truth} worksheet is similar to that described previously for the ROC and FROC paradigms. The only difference is the first entry in the Paradigm column, which is \texttt{LROC}.
\item
...
\caption{The FP worksheet for forced localization LROC Excel file `R/quick-start/lroc1.xlsx`}\label{fig:quick-start-lroc-fp1}
\end{figure}
...
\caption{The FP worksheet for forced localization false LROC Excel file `R/quick-start/lroc2.xlsx`}\label{fig:quick-start-lroc-fp2}
\end{figure}
