...
\NormalTok{effectSizeROC }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\FloatTok{0.01}\NormalTok{, }\FloatTok{0.105}\NormalTok{, }\FloatTok{0.005}\NormalTok{) }\CommentTok{\# length 20 vector}
