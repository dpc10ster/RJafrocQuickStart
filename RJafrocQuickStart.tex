...
\begin{itemize}
\item
  If there are more than two treatments in the pilot dataset extract those treatments that represent null hypothesis data: for example \texttt{DfExtractDataset(dataset,\ trts\ =\ c(1,2,4))} extracts treatments 1, 2 and 4. Save the extracted dataset to \texttt{dataset}. More than two treatments can be used if they have similar FOMs as the averaging/median procedure described below benefits from more data. However, the final sample size predictions are restricted to two treatments.
\item
...
\item
  For each treatment and reader the inferred ROC data is fitted by \texttt{FitRsmRoc()}, see example below, yielding estimates of the RSM \emph{physical} (or primed) parameters (not the \emph{intrinsic} values).
\item
...
The defining values of the fitting model are \texttt{muMed} = 3.3121519, \texttt{lambdaPMed} = 1.714368 and \texttt{nuPMed} = 0.7036564. Note that these obey the constraints \texttt{lambdaPMed\ \textgreater{}\ 0} and \texttt{0\ \textless{}\ nuP\ \textless{}\ 1}. One converts the physical parameters to the intrinsic values:
...
In terms of intrinsic parameters, the defining values of the fitting model are \texttt{muMed} = 3.3121519, \texttt{lambdaMed} = 5.6782473 and \texttt{nuMed} = 0.3672041. We are now ready to calculate the expected NH FOMs using the ROC -AUC and the wAFROC FOM.
...
\NormalTok{    muMed }\OperatorTok{+}\StringTok{ }\NormalTok{deltaMu[i], lambdaMed, nuMed, }\DataTypeTok{lesDistr =}\NormalTok{ lesDistr, }\DataTypeTok{OpChType =} \StringTok{"ROC"}\NormalTok{)}\OperatorTok{$}\NormalTok{aucROC }\OperatorTok{-}\StringTok{ }\NormalTok{aucRocNH}
\NormalTok{  eswAfroc[i] <-}\StringTok{ }\KeywordTok{PlotRsmOperatingCharacteristics}\NormalTok{(}
\NormalTok{    muMed}\OperatorTok{+}\StringTok{ }\NormalTok{deltaMu[i], lambdaMed, nuMed, }\DataTypeTok{lesDistr =}\NormalTok{ lesDistr, }\DataTypeTok{OpChType =} \StringTok{"wAFROC"}\NormalTok{)}\OperatorTok{$}\NormalTok{aucwAFROC }\OperatorTok{-}\StringTok{ }\NormalTok{aucwAfrocNH}
...
\begin{center}\includegraphics{18b-froc-sample-size_files/figure-latex/unnamed-chunk-8-1} \end{center}
...
The slope of the zero-intercept constrained straight line fit is \texttt{scaleFactor} = 2.1691632 and the squared correlation coefficient is \texttt{R2} = 0.9999904. Therefore, the conversion from ROC to wAFROC effect size is: \texttt{effectSizewAFROC\ =\ scaleFactor\ *\ effectSizeROC}. \textbf{The wAFROC effect size is twice the ROC effect size.} All that remains is to calculate the variance components using the two FOMs.
...
\begin{center}\includegraphics{18b-froc-sample-size_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
The fitting model is defined by \texttt{muMed} = 3.31491361, \texttt{lambdaMed} = 5.61237183 and \texttt{nuMed} = 0.36980616 and \texttt{lesDistr}. The effect size scale factor is 2.15372685.
...
\includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-1-1.pdf} \includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-1-2.pdf} \includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-1-3.pdf} \includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-1-4.pdf}
...
\includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-3-1.pdf} \includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-3-2.pdf} \includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-3-3.pdf} \includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-3-4.pdf}
...
\includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-5-1.pdf} \includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-5-2.pdf} \includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-5-3.pdf} \includegraphics{19a-f-distribution_files/figure-latex/unnamed-chunk-5-4.pdf}
...
\hypertarget{cbm-plots}{%
\chapter{CBM plots}\label{cbm-plots}}
...
\includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-2-1.pdf} \includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-2-2.pdf} \includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-2-3.pdf} \includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-2-4.pdf}
...
\includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-3-1.pdf} \includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-3-2.pdf} \includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-3-3.pdf} \includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-3-4.pdf}
...
\includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-4-1.pdf} \includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-4-2.pdf} \includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-4-3.pdf} \includegraphics{19g-cbm-plots_files/figure-latex/unnamed-chunk-4-4.pdf}
...
\chapter{ROI paradigm}\label{roi-paradigm}}
...
\CommentTok{#>   ..$ LL_IL: logi NA}
\CommentTok{#>  $ lesions     :List of 3}
\CommentTok{#>   ..$ perCase: int [1:40] 2 3 2 2 3 3 1 2 3 3 ...}
\CommentTok{#>   ..$ IDs    : num [1:40, 1:4] 2 1 1 1 1 2 4 1 1 1 ...}
\CommentTok{#>   ..$ weights: num [1:40, 1:4] 0.5 0.333 0.5 0.5 0.333 ...}
\CommentTok{#>  $ descriptions:List of 7}
\CommentTok{#>   ..$ fileName     : chr "datasetROI"}
\CommentTok{#>   ..$ type         : chr "ROI"}
\CommentTok{#>   ..$ name         : chr "SIM-ROI"}
...
\CommentTok{#>   ..$ readerID     : Named chr [1:5] "1" "2" "3" "4" ...}
\CommentTok{#>   .. ..- attr(*, "names")= chr [1:5] "1" "2" "3" "4" ...}
\NormalTok{datasetROI}\OperatorTok{$}\NormalTok{ratings}\OperatorTok{$}\NormalTok{NL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,]}
\CommentTok{#> [1]  0.9498680 -0.0582497 -0.7763780  0.0120730}
\KeywordTok{mean}\NormalTok{(datasetROI}\OperatorTok{$}\NormalTok{ratings}\OperatorTok{$}\NormalTok{NL[,,}\DecValTok{1}\OperatorTok{:}\DecValTok{50}\NormalTok{,])}
\CommentTok{#> [1] 0.1014348}
\NormalTok{datasetROI}\OperatorTok{$}\NormalTok{ratings}\OperatorTok{$}\NormalTok{NL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{51}\NormalTok{,]}
\CommentTok{#> [1] 1.01867 0.34710    -Inf    -Inf}
\NormalTok{datasetROI}\OperatorTok{$}\NormalTok{lesions}\OperatorTok{$}\NormalTok{perCase[}\DecValTok{1}\NormalTok{]}
\CommentTok{#> [1] 2}
\NormalTok{datasetROI}\OperatorTok{$}\NormalTok{ratings}\OperatorTok{$}\NormalTok{LL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,]}
\CommentTok{#> [1] 1.56928 2.05945    -Inf    -Inf}
\NormalTok{x <-}\StringTok{ }\NormalTok{datasetROI}\OperatorTok{$}\NormalTok{ratings}\OperatorTok{$}\NormalTok{LL;}\KeywordTok{mean}\NormalTok{(x[}\KeywordTok{is.finite}\NormalTok{(x)])}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fileName <-}\StringTok{ }\KeywordTok{system.file}\NormalTok{(}\StringTok{"extdata"}\NormalTok{, }\StringTok{"RoiData.xlsx"}\NormalTok{, }\DataTypeTok{package =} \StringTok{"RJafroc"}\NormalTok{, }\DataTypeTok{mustWork =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{ds <-}\StringTok{ }\KeywordTok{DfReadDataFile}\NormalTok{(fileName)}
\NormalTok{ds}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{type}
\CommentTok{#> [1] "ROI"}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\textwidth,height=\textheight]{images/ROI-Truth-1.png}
\includegraphics[width=1\textwidth,height=\textheight]{images/ROI-Truth-2.png}

\begin{itemize}
\tightlist
\item
  The \texttt{Truth} worksheet - this indicates which cases are diseased and which are non-diseased and the number of ROI-level-diseased region on each case.
...
\includegraphics[width=1\textwidth,height=\textheight]{images/ROI-TP-1.png}
...
\item
  ...
  \item
    One should be satisfied that for each diseased case the sum of the number of entries in the \texttt{TP} and \texttt{FP} worksheets is always 4.
  \end{itemize}
\end{itemize}
