...
\NormalTok{    muNH }\SpecialCharTok{+}\NormalTok{ deltaMu[i], lambdaNH, nuNH, }\AttributeTok{lesDistr =}\NormalTok{ lesDistr}\SpecialCharTok{$}\NormalTok{Freq)}\SpecialCharTok{$}\NormalTok{aucROC }\SpecialCharTok{{-}}\NormalTok{ aucRocNH}
\NormalTok{  eswAfroc[i] }\OtherTok{\textless{}{-}} \FunctionTok{UtilAnalyticalAucsRSM}\NormalTok{(}
\NormalTok{    muNH}\SpecialCharTok{+}\NormalTok{ deltaMu[i], lambdaNH, nuNH, }\AttributeTok{lesDistr =}\NormalTok{ lesDistr}\SpecialCharTok{$}\NormalTok{Freq)}\SpecialCharTok{$}\NormalTok{aucwAFROC }\SpecialCharTok{{-}}\NormalTok{ aucwAfrocNH}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{19-froc-sample-size_files/figure-latex/unnamed-chunk-7-1} 
...
\NormalTok{effectSizeROC }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\FloatTok{0.01}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.005}\NormalTok{)}
...
\NormalTok{  power\_afroc[i] }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{powerRRRC}
  ...
  \CommentTok{\# cat("ROC{-}ES = ", effectSizeROC[i], }
  \CommentTok{\#     ", wAFROC{-}ES = ", effectSizewAFROC[i], }
  \CommentTok{\#     ", Power{-}ROC = ", power\_roc[i], }
  \CommentTok{\#     ", Power{-}wAFROC = ", power\_afroc[i], "\textbackslash{}n")}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{aucRocNH }\OtherTok{\textless{}{-}} \FunctionTok{UtilAnalyticalAucsRSM}\NormalTok{(}
\NormalTok{  muNH, lambdaNH, nuNH, }
  \AttributeTok{lesDistr =}\NormalTok{ lesDistr}\SpecialCharTok{$}\NormalTok{Freq)}\SpecialCharTok{$}\NormalTok{aucROC}

\NormalTok{aucwAfrocNH }\OtherTok{\textless{}{-}} \FunctionTok{UtilAnalyticalAucsRSM}\NormalTok{(}
\NormalTok{  muNH, lambdaNH, nuNH, }
  \AttributeTok{lesDistr =}\NormalTok{ lesDistr}\SpecialCharTok{$}\NormalTok{Freq)}\SpecialCharTok{$}\NormalTok{aucwAFROC}
\end{Highlighting}
\end{Shaded}
