...
\hypertarget{getting-help-on-the-software}{%
\section{Getting help on the software}\label{getting-help-on-the-software}}
...
\hypertarget{contributors-to-the-software}{%
\subsection{Contributors to the software}\label{contributors-to-the-software}}
...
\hypertarget{dataset-contributors}{%
\subsection{Dataset contributors}\label{dataset-contributors}}
...
\hypertarget{part-dbm-method}{%
\part*{DBM method}\label{part-dbm-method}}
\addcontentsline{toc}{part}{DBM method}
...
\hypertarget{part-or-method}{%
\part*{OR method}\label{part-or-method}}
\addcontentsline{toc}{part}{OR method}
...
\item
  We illustrate with a toy FROC data file in the \texttt{RJafroc} GitHub repository, \texttt{inst/extdata/toyFiles/FROC/frocCr.xlsx}, in which 3 readers interpret 3 non-diseased and 5 diseased cases using the FROC paradigm.
\item
...
\item
  The \texttt{Truth} worksheet contains 6 columns: \texttt{CaseID}, \texttt{LesionID}, \texttt{Weight}, \texttt{ReaderID}, \texttt{ModalityID} and \texttt{Paradigm}.
\item
  The non-diseased cases are numbered 1,2,3; the diseased cases are numbered 70, 71, 72, 73, 74; i.e., \texttt{K1} = 3, \texttt{K2} = 5 and \texttt{K} = 8.
\item
  The \texttt{ReaderID} field has \emph{three values} \texttt{0,\ 1,\ 2}.
\item
  \texttt{ModalityID}: The first modality is labeled \texttt{0} and the second is `1'.
\item
  Note that \texttt{ReaderID} and \texttt{ModalityID} are \emph{text formatted labels}.
\item
  \texttt{Paradigm}: The contents of this field are \texttt{FROC} and \texttt{FCTRL} (case insensitive, FCTRL stands for a factorial - or fully crossed - study design where each reader interprets all cases in all modalities).
\end{itemize}

\hypertarget{the-structure-of-the-froc-factorial-dataset}{%
\section{The structure of the FROC factorial dataset}\label{the-structure-of-the-froc-factorial-dataset}}
...
\tightlist
\item
  Note that \texttt{newExcelFileFormat} \textbf{must} be set to \texttt{TRUE} to read the new Excel format dataset. The default is \texttt{FALSE} which applies to the old format Excel file with only the first three columns present in the \texttt{Truth} worksheet.
\end{itemize}
...
\item
  The number of lesions per diseased case is the vector \texttt{x\$lesions\$perCase}, i.e., 2, 1, 3, 2, 1 in this example.
\item
  The \texttt{x\$descriptions\$dataType} member is FROC, which specifies the data collection method.
\item
...
\item
  The \texttt{x\$descriptions\$design} member is FCTRL; specifies the study design.
\item
  The \texttt{x\$descriptions\$truthTableStr} member quantifies the structure of the dataset, explained next.
\end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{all}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{,}\DecValTok{1}\NormalTok{] }\OperatorTok{==}\DecValTok{1}\NormalTok{)}
\CommentTok{#> [1] TRUE}
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{4}\OperatorTok{:}\DecValTok{8}\NormalTok{,}\DecValTok{1}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{,}\DecValTok{2}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\KeywordTok{all}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{4}\OperatorTok{:}\DecValTok{8}\NormalTok{,}\DecValTok{2}\NormalTok{] }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\CommentTok{#> [1] TRUE}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{,}\DecValTok{3}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\CommentTok{# first diseased case}
\KeywordTok{all}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{4}\NormalTok{,}\DecValTok{3}\NormalTok{] }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\CommentTok{#> [1] TRUE}
\CommentTok{# second diseased case}
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{5}\NormalTok{,}\DecValTok{3}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\CommentTok{# third diseased case}
\KeywordTok{all}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{6}\NormalTok{,}\DecValTok{3}\NormalTok{] }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\CommentTok{#> [1] TRUE}
\CommentTok{# fourth diseased case}
\KeywordTok{all}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{7}\NormalTok{,}\DecValTok{3}\NormalTok{] }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\CommentTok{#> [1] TRUE}
\CommentTok{# fifth diseased case}
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{8}\NormalTok{,}\DecValTok{3}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# all non diseased cases}
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\CommentTok{# first diseased case}
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{4}\NormalTok{,}\DecValTok{4}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\CommentTok{# second diseased case}
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{5}\NormalTok{,}\DecValTok{4}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\CommentTok{# third diseased case}
\KeywordTok{all}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{] }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\CommentTok{#> [1] TRUE}
\CommentTok{# fourth diseased case}
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{7}\NormalTok{,}\DecValTok{4}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\CommentTok{# fifth diseased case}
\KeywordTok{all}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(x}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\DecValTok{8}\NormalTok{,}\DecValTok{4}\NormalTok{]))}
\CommentTok{#> [1] TRUE}
\end{Highlighting}
\end{Shaded}
