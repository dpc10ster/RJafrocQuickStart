...
* The `x$descriptions$type` member is `r x$descriptions$type`, which specifies the data collection method. 
...
* The `x$descriptions$design` member is `r x$descriptions$design`; it specifies the study design. 
