...
frocSampleSize(ds, J = 5, K = 100, effectSizeROC = 0.07)
```
...
cat("All data", "\n\n")
frocSampleSize(ds, J = 5, K = 100, effectSizeROC = 0.05)

cat("NH treatments only", "\n\n")
frocSampleSize(DfExtractDataset(ds, trts = c(1,2)), J = 5, K = 100, effectSizeROC = 0.05)
```
...
cat("All data", "\n")
frocSampleSize(ds, J = 5, K = 100, effectSizeROC = 0.06)

cat("NH treatments only", "\n")
frocSampleSize(DfExtractDataset(ds, trts = c(1,5)), J = 5, K = 100, effectSizeROC = 0.06)
```
...
cat("All data", "\n")
frocSampleSize(ds, J = 5, K = 100, effectSizeROC = 0.03)

cat("NH treatments only", "\n")
frocSampleSize(DfExtractDataset(ds, trts = c(3,4)), J = 5, K = 100, effectSizeROC = 0.03)
```
...
cat("NH treatments only", "\n")
frocSampleSize(DfExtractDataset(ds, trts = c(3,4)), J = 5, K = 100, effectSizeROC = 0.05)
```
