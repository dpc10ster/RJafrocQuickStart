...
In the following code the function `SsSampleSizeKGivenJ` returns the number of cases needed for 80 percent power for the wAFROC effect size = `r round(effectSizewAFROC, 3)` and wAFROC variance components as just computed above.
