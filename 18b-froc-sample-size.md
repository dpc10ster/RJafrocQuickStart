...
FROC sample size estimation is split into two parts. The first part goes into the details. The second part encapsulates most of the details in a new function, which makes for easier application.
